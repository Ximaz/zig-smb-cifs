...
/// @brief Data buffer format codes are used to identify the type and format of
...
pub const SmbDataBufferFormatCode = enum(u8) {
    /// @brief A two-byte u16 value indicating the length of the data buffer.
    ...
    /// @brief A two-byte u16 value indicating the length of the variable
